...
//the linked list stored within each object of the hash array, contains a nodeobj to be defined w/ key, value, next, you should prolly copy from other assignments
// each node contains the address of head
